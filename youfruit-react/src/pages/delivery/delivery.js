            ...
            <div className="delivery-payment">
                <section className="delivery">
                    <div className="container-xs">
                        ...
                        <div className="delivery__innerWrap">
                            <div className="delivery__item">
                                <img src={require(`../../img/icons/np.png`)} alt="novaposhta" className="delivery__img" />
                                <div>
                                    <p className="delivery__name text_md font_semibold">Новая Почта</p>
                                    <p className="delivery__info text_sm font_regular">Доставка в течении 1-2 дней</p>
                                    <p className="delivery__description text_sm font_regular">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur expedita unde, earum ipsum hic fugit eaque delectus sunt. Itaque, perferendis!</p>
                                </div>
                            </div>
                            <div className="delivery__item">
                                <img src={require(`../../img/icons/up.png`)} alt="novaposhta" className="delivery__img" />
                                <div>
                                    <p className="delivery__name text_md font_semibold">Укрпочта</p>
                                    <p className="delivery__info text_sm font_regular">Доставка в течении 1-2 дней</p>
                                    <p className="delivery__description text_sm font_regular">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur expedita unde, earum ipsum hic fugit eaque delectus sunt. Itaque, perferendis!</p>
                                </div>
                            </div>
                            <div className="delivery__item">
                                <img src={require(`../../img/icons/meest.png`)} alt="novaposhta" className="delivery__img" />
                                <div>
                                    <p className="delivery__name text_md font_semibold">MeestExpress</p>
                                    <p className="delivery__info text_sm font_regular">Доставка в течении 1-2 дней</p>
                                    <p className="delivery__description text_sm font_regular">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur expedita unde, earum ipsum hic fugit eaque delectus sunt. Itaque, perferendis!</p>
                                </div>
                            </div>
                            <div className="delivery__item">
                                <img src={require(`../../img/icons/justin.jpg`)} alt="novaposhta" className="delivery__img" />
                                <div>
                                    <p className="delivery__name text_md font_semibold">Justin</p>
                                    <p className="delivery__info text_sm font_regular">Доставка в течении 1-2 дней</p>
                                    <p className="delivery__description text_sm font_regular">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur expedita unde, earum ipsum hic fugit eaque delectus sunt. Itaque, perferendis!</p>
                                </div>
                            </div>
                            <div className="delivery__item">
                                <img src={require(`../../img/icons/truck.png`)} alt="novaposhta" className="delivery__img" />
                                <div>
                                    <p className="delivery__name text_md font_semibold">Самовывоз</p>
                                    <p className="delivery__info text_sm font_regular">Доставка в течении 1-2 дней</p>
                                    <p className="delivery__description text_sm font_regular">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur expedita unde, earum ipsum hic fugit eaque delectus sunt. Itaque, perferendis!</p>
                                </div>
                            </div>
                    ...
                    <div className="container-xs">
                        ...
                        <div className="payment__innerWrap">
                            ...
                            <div className="payment__type">
                                ...
                                <p className="payment__text text_md font_semibold">Наложенный платеж</p>
                            </div>
                        </div>
                    </div >
                </section>
