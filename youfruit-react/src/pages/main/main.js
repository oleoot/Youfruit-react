                                ...
                                <div className="container">
                                    <div className="main__inner">
                                        <div className="main__textWrap">
                                            <h1 className="main__headline text_xl">Пастила и Фруктовые чипсы</h1>
                        ...
                        <section className="main">
                            <div className="main__innerWrap">
                                <div className="container">
                                    <div className="main__inner">
                                        <div className="main__textWrap">
                                            <h1 className="main__headline text_xl">Конфеты, сделанные правильно</h1>
                                            <p className="main__description text_md">Без вредных веществ</p>
                                            <Link to="/shop" className="btn text_md">Магазин</Link>
                                        </div>
                                        <div className="main__imgWrap">
                                            {/* <img src={require(`../../img/pineapple.png`)} alt="pineapple" /> */}
                        ...
                        <div className="products__wrap">
                            ...
                            <div className="products__pane">
                                <div>
                                    ...
                                    <p className="products__description text_md">Пастила - это высушенное фруктовое пюре.
...
В состав пастилы входят исключительно свежие фрукты.</p>
                            ...
                            <div>
                                <img src={require(`../../img/products/pastila.jpg`)} alt="healthy" className="products__img" />
                            </div>
                            <div>
                                <img src={require(`../../img/products/frips.jpg`)} alt="healthy" id="img-bottom-right" className="products__img" />
                            </div>
                            <div className="products__pane">
                                <div>
                                    <p className="products__name">Натуральная пастила</p>
