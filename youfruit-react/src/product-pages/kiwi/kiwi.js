            ...
            <div className="kiwi" >
                <div className="container-sm container-products">
                    ...
                    <div className="product-wrap grid-container">
                        <div>
                            <img src={require(`../../img/products/kiwi.jpg`)} alt="kiwi" />
                        </div>

                        <div id="item-apple">
                            <p className="text-md">Фруктовые чипсы - киви</p>
                            ...
                            {cartTotal[info[5].id] !== 0 ?
                                <button disabled className="btn btn-added text-sm">Добавлено в корзину</button> :
                                <button onClick={() => {
                                    addToTotal(info[5].price, this.state.inputValue, info[5].id)
                                    addToCartNumber(info[5].id)
                                    addToCartProduct(info[5].id, info[5].name, info[5].price, info[5].img, this.state.inputValue)
