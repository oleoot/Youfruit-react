            ...
            <div className="banana" >
                <div className="container-sm">
                    <div className="product-wrap grid-container">
                        <div>
                            <img src={require(`../../img/products/banana.jpg`)} alt="banana" />
                        </div>

                        <div id="item-apple">
                            <p className="text-md">Фруктовые чипсы - банан</p>
                            ...
                            {cartTotal[info[3].id] !== 0 ?
                                <button disabled className="btn btn-added text-sm">Добавлено в корзину</button> :
                                <button onClick={() => {
                                    addToTotal(info[3].price, this.state.inputValue, info[3].id)
                                    addToCartNumber(info[3].id)
                                    addToCartProduct(info[3].id, info[3].name, info[3].price, info[3].img, this.state.inputValue)
